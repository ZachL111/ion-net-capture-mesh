...
`ion-net-capture-mesh` is centered on networking work in TypeScript. The technical target is: Design a TypeScript verification harness for capture systems, covering resource planning, capacity fixtures, and failure-oriented tests.
...
The score is deterministic. The current threshold is 170. Risk has a penalty of 5, latency has a penalty of 3, and weight contributes a bonus of 6.
