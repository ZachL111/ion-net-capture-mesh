"""Regression checks for the ion-net-capture-mesh casebook."""
...
from casebook.harness import assert_expected, ion_net_capture_mesh_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(ion_net_capture_mesh_summary(), assert_expected())
