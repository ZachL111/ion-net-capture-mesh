...
ion-net-capture-mesh is a TypeScript project for networking. It focuses on this technical goal: Design a TypeScript verification harness for capture systems, covering resource planning, capacity fixtures, and failure-oriented tests.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 170, risk penalty 5, latency penalty 3, and weight bonus 6. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
